...
## Pair With X Article Processor

Use this companion when the user needs to find X/Twitter articles, inspect
threads, check replies, or monitor related accounts before saving article
content. Keep article extraction in `x-article-processor` and keep social reads
or approved actions inside Hermes Tweet tools.
